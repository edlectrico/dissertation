...
\end{timeline}
\captionof{figure}{The chronological view of the evolution of remarkable user models.\label{fig:user_models}}
...
%sota user models
\input{2_state_of_the_art/user/2_1_orwant}
\input{2_state_of_the_art/user/2_2_fischer}
\input{2_state_of_the_art/user/2_3_gregor}
\input{2_state_of_the_art/user/2_3_II_gauch}
\input{2_state_of_the_art/user/2_4_razmerita}
\input{2_state_of_the_art/user/2_4_hatala}
\input{2_state_of_the_art/user/2_5_pereira}
\input{2_state_of_the_art/user/2_7_heckmann}
\input{2_state_of_the_art/user/2_6_persad}
\input{2_state_of_the_art/user/2_8_golemati}
\input{2_state_of_the_art/user/2_8_casas}
\input{2_state_of_the_art/user/2_9_evers}
\input{2_state_of_the_art/user/2_12_skillen}
\input{2_state_of_the_art/user/2_x_generic_systems}
\input{2_state_of_the_art/user/comparison}
