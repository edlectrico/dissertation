...
\ac{ccpp} is based on profiles. A profile contains components and attributes.
...
Here we present three of the most popular \ac{ddr} systems:

\myparagraph{\ac{wurfl}} 
