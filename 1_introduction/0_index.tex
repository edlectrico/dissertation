...
% However, regarding the real users, who still prefer older devices with physical
% interfaces (like physical buttons) we believe that new, smarter and more dynamic
% accessibility tools are needed to avoid the inattention of these users. Hence,
% during the following chapters we present AdaptUI, a twofold framework for users
% to have their user interfaces dynamically adapted 
% developing
% adaptive user interfaces for Android devices. 

% ----------------------------------------------------------------------

\input{1_introduction/1_motivation}
\input{1_introduction/2_hypothesis_and_goals}
\input{1_introduction/3_context}
\input{1_introduction/4_methodology}
\input{1_introduction/5_outline}
