...
Creating activities is easy. Extending the Activity class\textsuperscript{\ref{activities}},
...
example, by using the Android Text-To-Speech\footnote{\url{http://developer.android.com/reference/android/speech/tts/TextToSpeech.html}} service). Every decision
